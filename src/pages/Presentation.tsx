			...
			>
				<SwiperSlide>
					<section className="flex justify-center flex-col items-center p-2 ">
						<img src={kid} alt="teacher" className="max-w-[460px]" />
						<div
						...
						>
							...
							<AudioPlayButton className="absolute bottom-18 left-2 z-50" audioUrl="https://magenta-fox-373734.hostingersite.com/wp-content/uploads/2025/08/01-jack.mp3" />
						</div>
					</section>
				</SwiperSlide>
